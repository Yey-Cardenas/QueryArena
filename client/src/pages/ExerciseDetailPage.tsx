...
export default function ExerciseDetailPage() {
  ...
  return (
    <div style={styles.container}>
      ...
      {/* Exercise detail card (Requirement 4.4) */}
      <div style={styles.card}>
        <div style={styles.metaRow}>
          <span style={styles.badge}>{exercise.level.name}</span>
          <span style={styles.badge}>{exercise.category.name}</span>
      ...
      {/* SQL editor form (Requirements 5.1, 15.1) */}
      <div style={styles.card}>
        <h2 style={styles.sectionTitle}>Tu solución SQL</h2>

        <form onSubmit={handleSubmit} noValidate>
          <div style={styles.field}>
            <label htmlFor="sql-query" style={styles.label}>
            ...
            <textarea
              ...
              style={{
                ...styles.textarea,
                ...(queryError ? styles.textareaError : {}),
              }}
              aria-describedby={queryError ? 'query-error' : undefined}
            />
            {queryError && (
              <span id="query-error" style={styles.fieldError} role="alert">
                {queryError}
              </span>
            )}
          </div>
      ...
      {/* Result panel (Requirements 7.1, 7.4) */}
      {result && (
        <div
          style={{
            ...styles.card,
        ...
        >
          ...
          <div style={styles.resultRow}>
            ...
            <span style={styles.resultValue}>
              {(result.resolutionTimeMs / 1000).toFixed(1)} s
            </span>
          </div>
